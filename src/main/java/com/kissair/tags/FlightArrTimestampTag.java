...
/**
 * The FlightArrTimestampTag class, whose purpose is to format flight arrival
 * date and time for usage in jsp.
 */
public class FlightArrTimestampTag extends SimpleTagSupport {
	...
	Date date = flight.getArrTimestamp();
